...
<div class="right">
  ...
  <br/>
  <br/>
  <font style="margin-left: 60px">用户名：${user.username}<br/><br/></font>
  <font style="margin-left: 60px">手机号：${user.telephone}<br/><br/></font>
  <font style="margin-left: 60px">邮&emsp;箱：${user.email}<br/><br/></font>
